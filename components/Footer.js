    ...
    <footer className="container grid grid-cols-5 mt-0 xl:ml-80 ml-8 px-5 py-8 mx-auto items-center object-cover text-gray-600 body-font fixed bottom-0">
      <div className="sm:flex-row flex-col">
        ...
        <article className="col-start-2 xl:pl-32 lg:pl-20 md:pl-8 sm:pl-2 border-r-2 ">
          <font size="20" color="#FFF"> 2023
          </font>
        </article>
      </div>

      <p>
        <h className="pl-3">.A.K. ---</h>
        <a
      ...
      >
        <linearGradient
          id="kgRuRVfhYbsg7F4Xxd2wXa_dSdVIYLfZB7v_gr1"
          x1="32"
          x2="32"
          y1="-1703.5"
          y2="-1757.251"
        ...
        <path
          fill="url(#kgRuRVfhYbsg7F4Xxd2wXa_dSdVIYLfZB7v_gr1)"
        ...
        ></path>
        <linearGradient
          id="kgRuRVfhYbsg7F4Xxd2wXb_dSdVIYLfZB7v_gr2"
          x1="31"
          x2="31"
          y1="-1721.333"
          y2="-1741.616"
        ...
        <path
          fill="url(#kgRuRVfhYbsg7F4Xxd2wXb_dSdVIYLfZB7v_gr2)"
